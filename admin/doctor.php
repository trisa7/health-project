	...
	$(document).on('click', '.edit_button', function(){
		...
		$.ajax({
	      	...
	      	success:function(data)
	      	{
				...
				$('#doctor_hospital_name').val(data.doctor_hospital_name);
    ...
    $(document).on('click', '.view_button', function(){
        ...
        $.ajax({
            ...
            success:function(data)
            {
				...
				html += '<tr><th width="40%" class="text-right">Doctor Hospital Name</th><td width="60%">'+data.doctor_hospital_name+'</td></tr>';

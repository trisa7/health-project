...
if(isset($_POST["action"]))
{
	if($_POST["action"] == 'fetch')
	{
		...
		if(isset($_POST["search"]["value"]))
		{
			...
			$search_query .= 'OR doctor_hospital_name LIKE "%'.$_POST["search"]["value"].'%" ';
		...
		foreach($result as $row)
		{
			...
			$sub_array[] = $row["doctor_hospital_name"];
		...
		else
		{
			...
			if($error == '')
			{
				$data = array(
					...
					':doctor_hospital_name'					=>	$object->clean_input($_POST["doctor_hospital_name"]),
				...
				(doctor_email_address, doctor_password, doctor_name, doctor_hospital_name, doctor_profile_image, doctor_phone_no, doctor_address, doctor_date_of_birth, doctor_degree, doctor_expert_in, doctor_status, doctor_added_on) 
	...
	if($_POST["action"] == 'fetch_single')
	{
		...
		foreach($result as $row)
		{
			...
			$data['doctor_hospital_name'] = $row['doctor_hospital_name'];

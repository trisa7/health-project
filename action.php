...
if(isset($_POST["action"]))
{
	...
	if($_POST['action'] == 'patient_register')
	{
		...
		else
		{
			...
			$mail->Port = 587;
			$mail->SMTPAuth = TRUE;
			$mail->Username = 'trish26mail@gmail.com';
			$mail->Password = 'trish12345';
			$mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
			//$mail->From = 'trish26mail@gmail.com';
			$mail->FromName = 'CureAndSure';
			//$mail->AddAddress($_POST["patient_email_address"]);
			$mail-> SetFrom ('trish26mail@gmail.com',"Trisa Nandi");
			//x$mail-> AddReplyTo('trish26mail@gmail.com',"Trisa Nandi");
			$mail->AddAddress('nandi.tultul24@gmail.com');
			$mail->WordWrap = 50;
			$mail->IsHTML(true);
